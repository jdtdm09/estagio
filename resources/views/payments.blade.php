...
<div id="paypal-form" style="max-width: 400px; margin: 0 auto; padding: 20px; text-align: center; background-color: #fff; border: 1px solid #ddd; border-radius: 4px; box-shadow: 0 0 10px rgba(0,0,0,.1); position: absolute;   top: 50%;   left: 50%;   transform: translate(-50%, -50%);">
    ...
    <br />
    <br />
    <form method="POST" action="{{ route('paymentProcess', ['evento' => $eventId, 'metodo' => $metodo]) }}">
        @csrf
        ...
        <div>
            <button type="submit" style="background-color: #4e73df; color: #fff; border: none; border-radius: 4px; padding: 10px 20px; cursor: pointer;">Efetuar Pagamento</button>
        </div>
    </form>
</div>
<?php endif; ?>
...
<div id="credit-card-form" style="max-width: 400px; margin: 0 auto; padding: 20px; text-align: center; background-color: #fff; border: 1px solid #ddd; border-radius: 4px; box-shadow: 0 0 10px rgba(0,0,0,.1); position: absolute;   top: 50%;   left: 50%;   transform: translate(-50%, -50%);">
...
<div id="mbway-form" style="max-width: 400px; margin: 0 auto; padding: 20px; text-align: center; background-color: #fff; border: 1px solid #ddd; border-radius: 4px; box-shadow: 0 0 10px rgba(0,0,0,.1); position: absolute;   top: 50%;   left: 50%;   transform: translate(-50%, -50%);">
