            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <form method="POST" action="{{ route('notificationStore') }}" class="grid grid-cols-1 gap-6 mt-4" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div>
                                ...
                                <x-input id="titulo" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="titulo" required autofocus />
                            </div>

                            <!-- Descrição -->
                            <div class="mt-4 flex items-center">
                                <label for="assunto" class="block text-gray-700 font-bold mb-2 flex items-center justify-center">
                                    Assunto
                                </label>
                                <textarea id="assunto" class="ml-2 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" rows="4" cols="50" name="assunto" required></textarea>
                            </div>                                                                                                                               
